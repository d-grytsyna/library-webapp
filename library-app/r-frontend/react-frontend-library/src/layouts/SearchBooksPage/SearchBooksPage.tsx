...
export const SearchBooksPage = () => {
  ...
  const categoryField = (value: string) =>{
    setCurrentPage(1);
    if(
      value.toLocaleLowerCase() === 'business' ||
      value.toLocaleLowerCase() === 'science' ||
      value.toLocaleLowerCase() === 'history' ||
      value.toLocaleLowerCase() === 'cooking'
  ...
  return (
    <div className="custom-background-container search-page-main-container py-5">
          ...
          <div className="row">
            ...
            <div className="col-4">
              <div className="dropdown">
                <button
                  className="btn secondary-color dropdown-toggle"
                  type="button"
                ...
                >
                  ...
                  <li onClick={()=>categoryField('Cooking')}>
                    <a href="#" className="dropdown-item">
                      Cooking
                    </a>
                  </li>
