...
export const Messages = () =>{
    ...
    return(
        <div className="mt-2">
            {messages.length>0 ?
            <>
            <h5 className="secondary-color-text">Current Q/A: </h5>
                ...
                <div key = {message.id}>
                    ...
                    p-3 bg-body rounded">
                        ...
                        <div>
                            ...
                            <>
                            <h6 className="secondary-color-text">{message.adminEmail} Admin</h6>
                            <p className="secondary-color-text">{message.response}</p>
                            </>  :
