...
export const PaymentPage = () =>{
    ...
    return(
        <div className="container">
            {fees>0&& <div className="container d-flex  align-items-center flex-column">
                <h5 className="mt-5">Fees pending: <span className="text-danger">${fees}</span></h5>
                <div className="col-6 d-flex   flex-column">
                    <h5 className="mb-3">Credit Card</h5>
                    <CardElement id='card-element'></CardElement>
                    <button disabled={submitDisabled}
                    type="button" className="btn btn-md main-color text-white mt-3"
                    onClick={checkout}>
                        Pay fees
                    </button>
                </div>
        ...
        {submitDisabled&& <SpinnerLoading></SpinnerLoading>}
        </div>
    );
}